...
function groups.get(contrast)
  ...
  return {
    ...
    BlinkCmpKindKindText                 = { link = "PmenuKind" },
    BlinkCmpKindKindMethod               = { link = "PmenuKind" },
    BlinkCmpKindKindFunction             = { link = "PmenuKind" },
    BlinkCmpKindKindConstructor          = { link = "PmenuKind" },
    BlinkCmpKindKindField                = { link = "PmenuKind" },
    BlinkCmpKindKindVariable             = { link = "PmenuKind" },
    BlinkCmpKindKindClass                = { link = "PmenuKind" },
    BlinkCmpKindKindInterface            = { link = "PmenuKind" },
    BlinkCmpKindKindModule               = { link = "PmenuKind" },
    BlinkCmpKindKindProperty             = { link = "PmenuKind" },
    BlinkCmpKindKindUnit                 = { link = "PmenuKind" },
    BlinkCmpKindKindValue                = { link = "PmenuKind" },
    BlinkCmpKindKindEnum                 = { link = "PmenuKind" },
    BlinkCmpKindKindKeyword              = { link = "PmenuKind" },
    BlinkCmpKindKindSnippet              = { link = "PmenuKind" },
    BlinkCmpKindKindColor                = { link = "PmenuKind" },
    BlinkCmpKindKindFile                 = { link = "PmenuKind" },
    BlinkCmpKindKindReference            = { link = "PmenuKind" },
    BlinkCmpKindKindFolder               = { link = "PmenuKind" },
    BlinkCmpKindKindEnumMember           = { link = "PmenuKind" },
    BlinkCmpKindKindConstant             = { link = "PmenuKind" },
    BlinkCmpKindKindStruct               = { link = "PmenuKind" },
    BlinkCmpKindKindEvent                = { link = "PmenuKind" },
    BlinkCmpKindKindOperator             = { link = "PmenuKind" },
    BlinkCmpKindKindTypeParameter        = { link = "PmenuKind" },
