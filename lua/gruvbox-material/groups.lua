...
function groups.get(contrast)
   ...
   return {
      ...
      NoiceCmdlineIcon                   = { link = "DiagnosticSignWarn" },
      ...
      NoiceCmdlinePrompt                 = { link = "FloatTitle" },
      ...
      BlinkCmpKindText                     = { fg   = colors.grey1 },
      BlinkCmpKindMethod                   = { fg   = colors.blue },
      BlinkCmpKindFunction                 = { fg   = colors.yellow },
      BlinkCmpKindConstructor              = { link = "BlinkCmpKindKindConstant" },
      BlinkCmpKindField                    = { fg   = colors.blue },
      BlinkCmpKindVariable                 = { fg   = colors.aqua },
      ...
      BlinkCmpKindProperty                 = { link = "BlinkCmpKindKindField" },
      ...
      BlinkCmpKindReference                = { link = "BlinkCmpKindKindConstant" },
      ...
      BlinkCmpKindEvent                    = { link = "BlinkCmpKindKindField" },
      ...
      SnacksBackdrop_000000          = { link = "Normal" },
      ...
      SnacksInputNormal              = { link = "Normal"                      },
      SnacksPickerBufNr              = { link = "Number"                      },
      SnacksPickerDir                = { link = "Comment"                     },
      SnacksWinKeySep                = { link = "Comment"                     },
      SnacksDashboardKey             = { link = "Number"                      },
      ...
      SnacksWinKeyDesc               = { link = "Function"                    },
      ...
      SnacksDashboardFooter          = { link = "Title"                       },
      SnacksDashboardHeader          = { link = "Title"                       },
      SnacksPickerGitBranch          = { link = "Title"                       },
      SnacksPickerGitBreaking        = { link = "Red"                         },
      SnacksPickerDesc               = { link = "Comment"                     },
      SnacksPickerIconName           = { link = "Red"                         },
      SnacksPickerLink               = { link = "Comment"                     },
      SnacksPickerIconClass          = { link = "Yellow"                      },
      SnacksPickerIconModule         = { link = "Blue"                        },
      SnacksPickerIconString         = { link = "Aqua"                        },
      SnacksWinKey                   = { link = "Statement"                   },
      SnacksPickerComment            = { link = "Comment"                     },
      SnacksPickerIconPackage        = { link = "Blue"                        },
      SnacksPickerInputSearch        = { link = "Red"                         },
      SnacksPickerIconCategory       = { link = "Blue"                        },
      SnacksPickerIconNamespace      = { link = "Blue"                        },
      SnacksPickerIconNumber         = { link = "Purple"                      },
      SnacksPickerIconObject         = { link = "Aqua"                        },
      SnacksPickerIconSource         = { link = "Aqua"                        },
      SnacksPickerIconConstant       = { link = "Aqua"                        },
      SnacksPickerIconVariable       = { link = "Blue"                        },
      SnacksPickerBorder             = { link = "Border"                      },
      SnacksPickerIconFunction       = { link = "Green"                       },
      SnacksPickerIconProperty       = { link = "Green"                       },
      SnacksPickerIconBoolean        = { link = "Boolean"                     },
      SnacksPickerDiagnosticSource   = { link = "Comment"                     },
      SnacksPickerIconOperator       = { link = "Orange"                      },
      SnacksPickerCmdBuiltin         = { link = "Green"                       },
      SnacksPickerIconConstructor    = { link = "Green"                       },
      SnacksPickerIconMethod         = { link = "Green"                       },
      SnacksPickerIconArray          = { link = "Fg"                          },
      SnacksPickerIconNull           = { link = "Yellow"                      },
      SnacksPickerPickWinCurrent     = { link = "Search"                      },
      SnacksPickerLabel              = { link = "Special"                     },
      SnacksDashboardTerminal        = { link = "Normal"                      },
      SnacksPickerBox                = { link = "NormalFloat"                 },
      SnacksPickerGitStatusCopied    = { link = "Special"                     },
      SnacksPickerGitStatusRenamed   = { link = "Special"                     },
      SnacksPickerList               = { link = "NormalFloat"                 },
      SnacksPickerInput              = { link = "NormalFloat"                 },
      SnacksPickerPreview            = { link = "NormalFloat"                 },
      SnacksPickerBoxCursorLine      = { link = "CursorLine"                  },
      SnacksPickerTitle              = { link = "Title"                       },
      SnacksPickerInputCursorLine    = { link = "CursorLine"                  },
      SnacksInputTitle               = { link = "Blue"                        },
      SnacksInputBorder              = { link = "Blue"                        },
      SnacksInputIcon                = { link = "Green"                       },
      SnacksPickerLinkBroken         = { link = "Red"                         },
      SnacksPickerIconEnum           = { link = "Yellow"                      },
      SnacksPickerLspAttachedBuf     = { link = "Blue"                        },
      SnacksPickerLspUnavailable     = { link = "Red"                         },
      SnacksPickerGitStatusStaged    = { link = "Green"                       },
      SnacksPickerGitStatusUnmerged  = { link = "Red"                         },
      SnacksPickerIconKey            = { link = "Red"                         },
      SnacksPickerIconStruct         = { link = "Yellow"                      },
      SnacksPickerGitDetached        = { link = "Yellow"                      },
      SnacksPickerLspAttached        = { link = "Yellow"                      },
      SnacksPickerLspDisabled        = { link = "Yellow"                      },
      SnacksWinBarNC                 = { link = "Title"                       },
      SnacksPickerIconField          = { link = "Blue"                        },
      SnacksPickerGitCommit          = { link = "Blue"                        },
      SnacksPickerGitStatusModified  = { link = "Yellow"                      },
      SnacksPickerUndoCurrent        = { link = "Blue"                        },
      SnacksPickerKeymapNowait       = { link = "Blue"                        },
      SnacksPickerIconInterface      = { link = "Yellow"                      },
      SnacksPickerIconEnumMember     = { link = "Aqua"                        },
      SnacksPickerBoxBorder          = { link = "Border"                      },
      SnacksPickerListBorder         = { link = "Border"                      },
      SnacksPickerInputBorder        = { link = "Border"                      },
      SnacksPickerPreviewBorder      = { link = "Border"                      },
      SnacksPickerFooter             = { link = "Title"                       },
      SnacksPickerBoxTitle           = { link = "Title"                       },
      SnacksPickerToggle             = { link = "Blue"                        },
      SnacksInputPrompt              = { link = "Blue"                        },
      SnacksPickerListTitle          = { link = "Title"                       },
      SnacksPickerInputTitle         = { link = "Title"                       },
      SnacksPickerPreviewTitle       = { link = "Title"                       },
      SnacksPickerIconTypeParameter  = { link = "Yellow"                      },
      SnacksPickerBoxFooter          = { link = "Title"                       },
      SnacksPickerListFooter         = { link = "Title"                       },
      SnacksPickerInputFooter        = { link = "Title"                       },
      SnacksPickerPreviewFooter      = { link = "Title"                       },
      SnacksPickerToggleRegex        = { link = "Blue"                        },
      SnacksPickerToggleFollow       = { link = "Blue"                        },
      SnacksPickerToggleHidden       = { link = "Blue"                        },
      SnacksPickerToggleIgnored      = { link = "Blue"                        },
      SnacksPickerToggleModified     = { link = "Blue"                        },
